...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:5173", "https://donations2.challs.umdctf.io"],
...
async def flag(request: Request):
    ...
    with lock:
        ...
        return Response(status_code=fastapi.status.HTTP_200_OK, content="UMDCTF{TeS7_your_CHAL1En93S 6UyS}")
